 ...
 */
JNIEXPORT jlong JNICALL Java_org_photonvision_coral_CoralJNI_create(JNIEnv *,
                                                                  jclass,
                                                                  jstring,
                                                                  jint, jint, jint);


JNIEXPORT jint JNICALL Java_org_photonvision_coral_CoralJNI_setCoreMask(JNIEnv *,
                                                                  jclass,
                                                                  jlong,
                                                                  jint);
 ...
 * Signature: (J)J
 */
JNIEXPORT void JNICALL Java_org_photonvision_coral_CoralJNI_destroy(JNIEnv *,
                                                                  jclass,
                                                                  jlong);
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_org_photonvision_coral_CoralJNI_detect(
